...
public class InGameCanvas : UICanvas
{
    ...
    public void OnIniT()
    {
        ...
        LevelManagerBeeGame.Ins.lineRendererObj.enabled = true;
        txt.text = "Level " + (LevelManagerBeeGame.Ins.level.id + 1);
    ...
    {
        UIManagerBeeGame.Ins.InGameCanvas = this;
    }

    public void Update()
    {
        if (LevelManagerBeeGame.Ins.isDed)
        {
