...
/*
	...
	public void ChangeLevel(int level)
	{
		...
		{
			Debug.LogError("Level Complete Hurray");
			return;
		}
		//Set up cai moi
		...
		GameControllerNutSort.Instance.NewGame();
	...
	public void CheckGameState()
	{
		...
		{
            GameControllerNutSort.Instance.WinGame();
			return;
		}
		if (currLevelObject.CheckLose())
		{
            GameControllerNutSort.Instance.LoseGame();
			return;
		}
	}
